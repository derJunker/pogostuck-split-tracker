...
contextBridge.exposeInMainWorld('electronAPI', {
    ...
    onSplitPassed: (callback: (event: Electron.IpcRendererEvent, splitInfo: { splitId: string, splitTime: number, splitDiff: number, golden: boolean, goldPace: boolean, onlyDiffColored: boolean, map3Route?: number}) => void) => ipcRenderer.on('split-passed', callback),
